# -*- coding: utf-8 -*-
"""DeepByWrite_triple_loss.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-4ur9SWQqCaO9UsVtF9H2TZnur6kZvoO
"""
...
def calculate_precision(threshold,dist,actual_issame):
  predict_issame = np.less(dist,threshold)
  tp = np.sum(np.logical_and(predict_issame, actual_issame))
  fp = np.sum(np.logical_and(predict_issame, np.logical_not(actual_issame)))
  tn = np.sum(np.logical_and(np.logical_not(predict_issame), np.logical_not(actual_issame)))
...
train_path = "/content/drive/My Drive/ColabNotebooks/DataProcessed/final_data_80_20/training_9/"
test_path = "/content/drive/My Drive/ColabNotebooks/DataProcessed/final_data_80_20/testing_9/"
